/**
 * Register Page — Serene Olive design
 */
import { createFileRoute, Link, redirect } from "@tanstack/react-router";
import { useCallback, useState } from "react";
import { getCurrentUser, registerUser } from "#/server/auth";
	...
	return (
		<main className="max-w-sm mx-auto px-6 py-16">
			<div className="mb-8 text-center">
				...
				<p className="text-sm text-text-muted mt-1">Buat akun Pangenget baru</p>
			</div>
			...
			<form onSubmit={handleSubmit} className="space-y-4">
				...
				<div>
					...
					>
						Nama{" "}
						<span className="text-text-muted/50 normal-case">(opsional)</span>
					</label>
					<input
						id="name"
						type="text"
